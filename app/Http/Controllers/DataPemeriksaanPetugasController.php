...
class DataPemeriksaanPetugasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/pemeriksaan/indexpemeriksaanbidan')->with('data', $data);
    }
    ...
    public function detail($id_balita)
    {
        ...
        return view('admin/pemeriksaan/detailpemeriksaanbidan')->with('data', $data);
    }
