                        ...
                        @foreach ($data['users'] as $item)
                            <tr>
                                ...
                                <td width = "10%" class="text-center">
                                    ...
                                    {{-- <a href="{{url('delete-bidan/'.$item->id)}}" class="btn btn-danger btn-sm"><i class = "fa fa-trash"></i></a> --}}
                                </td>
                            </tr>
                        @endforeach
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{url('insert-bidan')}}" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="Update{{$item->id}}">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{url('update-bidan')}}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
                        <label for="">Nama</label>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    <a href="{{url('delete-bidan/'.$item->id)}}" class="btn btn-success">Hapus</a>
                </div>
            </form>
        </div>
    </div>
