...
<section class="section">
    ...
    <div class="section-body">
        ...
        <!-- <a href="{{url('tambah-pemeriksaan')}}" class="btn btn-primary mb-2"><i class="fa fa-message"></i> Kirim Notifikasi</a> -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="caraukur" class="form-control" id="" required value = "{{$item->cara_ukur}}">
                                    ...
                                    <option value="BCG">Telentang</option>
                                    <option value="DPT 1">Berdiri</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="imunisasi" class="form-control" id="" required value = "{{$item->imunisasi}}">
                                    ...
                                    <option value="DPT 1">DPT-HB-HiB 1 Polio 2</option>
                                    <option value="DPT 2">DPT-HB-Hib 2 Polio 3</option>
                                    <option value="DPT 3">DPT-HB-Hib 3 Polio 4</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onclick="calculateStatusGizi()">Cek Status Gizi</button>
                                <label for="">Status Gizi</label>
                                
                                <input type="text" name="status_gizi" id="status_gizi" class="form-control" readonly value = "{{$item->statusGizi}}">{{$item->statusGizi}}>
                            </div>
                        </div>
                    </div>
    ...
    tooltip: {
        formatter: function () {
            ...
            if (this.series.name === 'Berat Badan') {
                ...
                s += '<br>Status Gizi: ' + statusGizi; // Menambahkan status gizi ke tooltip
            } else {
                s += '<br/>' + this.series.name + ': ' + this.y + ' cm/kg';
            }
            return s;
