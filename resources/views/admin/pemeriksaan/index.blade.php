                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($item->jumlah_pemeriksaan > 0)
                                        <a href="<?= url('detail-pemeriksaan/'.$item->id_balita)?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                        
                                    @else
                                        -
                                    @endif
                                    {{-- <a href="<?= url('update-pemeriksaan/'.$item->id_pemeriksaan)?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a> --}}
                                    {{-- <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#Update{{$item->id_balita }}">
                                        <i class="fa fa-edit"></i> 
                                    </button>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete{{$item->id_balita}}">
